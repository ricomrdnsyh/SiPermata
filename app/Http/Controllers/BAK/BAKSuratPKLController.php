...
class BAKSuratPKLController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('bak.surat_pkl.index', compact('listProdi'));
    }
    ...
    public function getSuratPKL(Request $request)
    {
        ...
        $query = SuratPKL::whereHas('mahasiswa', function ($q) use ($fakultasId) {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('action', function ($row) {
                $showBtn = '<a href="' . route('bak.surat-pkl.show', $row->id_surat_pkl) . '" class="btn btn-sm btn-light btn-active-light-info text-center" data-bs-toggle="tooltip" 
                data-bs-title="Detail"><i class="fa fa-file-alt"></i></a>';

                $editBtn = '<a href="' . route('bak.surat-pkl.edit', $row->id_surat_pkl) . '" class="btn btn-sm btn-light btn-active-light-warning text-center" data-bs-toggle="tooltip" 
    ...
    public function store(Request $request, SuratPKLGenerator $generatorService)
    {
        ...
        return redirect()->route('bak.surat-pkl.index')->with('success', 'Pengajuan surat berhasil diajukan! Silakan tunggu proses persetujuan.');
    }
