...
class MahasiswaSuratPKLController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('mahasiswa.surat_pkl.create', compact('latestAkademik', 'mitra', 'dataSimpt'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('mahasiswa.surat_pkl.edit', compact('surat', 'latestAkademik', 'mitra', 'dataSimpt'));
    }
