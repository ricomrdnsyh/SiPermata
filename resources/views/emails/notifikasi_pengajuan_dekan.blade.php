...
<head>
    ...
    <title>Pengajuan Surat Menunggu Dekan</title>
    <style>
        body {
        ...
        <tr>
            <td align="center" style="padding: 20px 0;">
                <table class="container" cellpadding="0" cellspacing="0" border="0" role="presentation">
                    <tr>
                        <td class="header">
                            <h1>Pengajuan Surat Menunggu Persetujuan Dekan</h1>
                            <p>Sistem Informasi Pengajuan Surat Mahasiswa Terpadu</p>
                        </td>
                    </tr>
                    <tr>
                        <td class="content">
                            <p>
                                Yth. <b>Dekan Fakultas {{ $namaFakultas }}</b>,<br>
                                Terdapat pengajuan surat mahasiswa yang telah
                                <b>disetujui oleh BAK</b> dan saat ini <b>menunggu persetujuan Dekan</b>.
                            </p>
                            <p style="margin-top: 10px; margin-bottom: 15px;">
                                <span class="badge badge-waiting">Menunggu Validasi Dekan</span>
                            </p>
                            <div class="info-box">
                                <table class="info-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="value">SURAT {{ $namaSurat }}</td>
                                    </tr>
                                    <tr>
                            ...
                            @if ($urlDetail)
                                <div class="cta-box">
                                    <p style="margin-bottom: 10px;">
                                        Silakan meninjau dan memvalidasi pengajuan ini melalui sistem pada tautan
                                        berikut:
                                    </p>
                            ...
                            <p style="margin-top: 25px;">
                                Terima kasih atas perhatian dan tindak lanjut Bapak/Ibu Dekan.
                            </p>
