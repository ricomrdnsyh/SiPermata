                    ...
                    <div class="card-body p-lg-17">
                        <div class="d-flex flex-column">
                            <div class="mb-13 text-center">
                                <h1 class="fs-2hx fw-bolder mb-5">Detail Surat Permohonan Rekomendasi</h1>
                            ...
                            <div id="form-container" class="mt-2">
                                <form id="kt_ecommerce_settings_general_form"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <textarea name="keperluan" class="form-control mb-3 mb-lg-0" rows="3" disabled>{{ old('keperluan', $surat->keperluan) }}</textarea>
                                    </div>
                                    <div class="fv-row mb-7">
                                        <label class="required fw-semibold fs-6 mb-2">Penyelenggara</label>
                                        <textarea name="penyelenggara" class="form-control mb-3 mb-lg-0" rows="3" disabled>{{ old('penyelenggara', $surat->penyelenggara) }}</textarea>
                                    </div>
                                    <div class="fv-row mb-7">
