                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div id="form-container" class="mt-2">
                                <form id="kt_ecommerce_settings_general_form"
                                    ...
                                    action="{{ route('bak.surat-rekomendasi.store') }}">
                                    @csrf
                                    <div class="row">
                                                ...
                                                <select class="form-select form-select-sm select2-hidden-accessible w-100"
                                                    ...
                                                    @foreach ($akademik as $item)
                                                        <option value="{{ $item->id_akademik }}"
                                                            {{ old('akademik_id') == $item->id_akademik ? 'selected' : '' }}>
                                                            {{ $item->tahun_akademik }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-12">
                                            <div class="fv-row mb-3">
                                                ...
                                                <textarea name="keperluan" placeholder="Penerima Beasiswa GenBi, MBKM Santri, dll" class="form-control form-control-sm mb-3 mb-lg-0"
