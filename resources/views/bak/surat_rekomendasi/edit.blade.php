                    ...
                    <div class="card-body p-lg-8">
                        <div class="d-flex flex-column">
                            <div class="mb-6 text-center">
                                <h1 class="fs-2hx fw-bolder mb-3">Edit Surat Permohonan Rekomendasi</h1>
                            ...
                            <div id="form-container" class="mt-2">
                                <form id="kt_ecommerce_settings_general_form"
                                    ...
                                    action="{{ route('bak.surat-rekomendasi.update', $surat->id_surat_rekomendasi) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="fv-row mb-3">
                                                ...
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input id="tgl_pelaksanaan" type="text" name="tgl_pelaksanaan"
                                                        ...
                                                        value="{{ $surat->tgl_pelaksanaan }}" autocomplete="off" required />
                                                </div>
                                            ...
                                            <div class="fv-row mb-3">
                                                ...
                                                <textarea name="keperluan" placeholder="Penerima Beasiswa GenBi, MBKM Santri, dll" class="form-control form-control-sm"
                                                    rows="3" required>{{ old('keperluan', $surat->keperluan) }}</textarea>
                                                @error('keperluan')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="fv-row mb-3">
                                                ...
                                                <textarea name="penyelenggara" placeholder="Bank Indonesia, LP3M Universitas Nurul Jadid, dll"
                                                    class="form-control form-control-sm" rows="3" required>{{ old('penyelenggara', $surat->penyelenggara) }}</textarea>
                                                @error('penyelenggara')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            flatpickr(document.getElementById('tgl_pelaksanaan'), {
                ...
                allowInput: true,
                defaultDate: "{{ $surat->tgl_pelaksanaan }}",
            ...
            const simptUrl = "{{ route('bak.surat-rekomendasi.simpt', '__NIM__') }}";
            ...
            const initialNim = document.getElementById('select-nim').value;
            if (initialNim) {
                fetchSimpt(initialNim);
            }
