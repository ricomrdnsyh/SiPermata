    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Detail TTD Surat</h5>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="fv-row mb-3">
                            ...
                            <input type="text" id="show_template" class="form-control form-control-sm" disabled />
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="fv-row mb-3">
                            <label class="fw-semibold fs-6 mb-2">Nama TTD</label>
                            <input type="text" id="show_nama_ttd" class="form-control form-control-sm" disabled />
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="fv-row mb-3">
                            <label class="fw-semibold fs-6 mb-2">NIDN</label>
                            <input type="text" id="show_nidn" class="form-control form-control-sm" disabled />
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="fv-row mb-3">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="fv-row mb-3">
                            ...
                            <div id="show_status_container"></div>
                        </div>
                    </div>
                </div>
            </div>
