...
@include('bak.ttd.create')
@include('bak.ttd.edit')
@include('bak.ttd.show')
@endsection
@section('js')
    ...
    @include('bak.ttd.script.index')
    @include('bak.ttd.script.create')
    @include('bak.ttd.script.edit')
    @include('bak.ttd.script.show')
@endsection
