                        ...
                        <div class="card-header border-0 pt-6">
                            <div class="card-title">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Rekapitulasi Surat Fakultas
                                        {{ $namaFakultas }}</span>
                                    <span class="text-muted mt-1 fw-semibold fs-7">Hanya menampilkan surat dengan status
                                        <span class="badge text-white bg-primary">Selesai</span></span>
                                </h3>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-export-excel').on('click', function(e) {
                e.preventDefault();
                const url = '{{ route('bak.rekapitulasi.exportExcel') }}?' + getFilterParams();
            ...
            $('#btn-download-bulk').on('click', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        const url = '{{ route('bak.rekapitulasi.downloadBulk') }}?' +
                            getFilterParams();
