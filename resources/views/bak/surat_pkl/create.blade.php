                    ...
                    <div class="card-body p-lg-8">
                        <div class="d-flex flex-column">
                            ...
                            <div id="form-container" class="mt-2">
                                <form id="kt_ecommerce_settings_general_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{ route('bak.surat-pkl.store') }}">
                                    @csrf
                                    <div class="row">
                                        ...
                                        @include('bak.surat_pkl._anggota_kelompok', ['anggotaKelompok' => old('anggota_kelompok', []), 'mahasiswa' => $mahasiswa])
                                    </div>
