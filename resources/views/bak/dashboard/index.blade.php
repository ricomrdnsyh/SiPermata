                    ...
                    <div class="card card-flush mb-8">
                        <div
                            ...
                            <div class="card-title order-1 order-md-1">
                                <h2 class="d-flex flex-column flex-md-row align-items-center align-items-md-start">
                                    Selamat Datang,
                                    <span class="position-relative ms-0 ms-md-2 d-inline-block text-danger">
                                        {{ $user_name ?? 'Pengguna' }}
                                        <span
        ...
        const suratChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: chartColors.map(color => color.replace('0.7', '1')), // Warna solid
