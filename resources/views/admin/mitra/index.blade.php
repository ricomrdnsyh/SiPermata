...
@section('js')
    ...
    @include('admin.mitra.script.index')
    @include('admin.mitra.script.create')
    @include('admin.mitra.script.edit')
    @include('admin.mitra.script.show')
@endsection
