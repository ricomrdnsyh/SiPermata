...
@section('js')
    ...
    @include('admin.template.script.index')
    @include('admin.template.script.create')
    @include('admin.template.script.edit')
    @include('admin.template.script.show')
@endsection
