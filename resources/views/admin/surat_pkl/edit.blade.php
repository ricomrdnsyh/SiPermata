                    ...
                    <div class="card-body p-lg-8">
                        <div class="d-flex flex-column">
                            ...
                            <div id="form-container" class="mt-2">
                                <form id="kt_ecommerce_settings_general_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST" action="{{ route('admin.surat-pkl.update', $surat->id_surat_pkl) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
