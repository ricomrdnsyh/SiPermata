            ...
            <div id="kt_app_content" class="app-content flex-column-fluid mt-7">
                ...
                <div class="card shadow-sm border border-dashed border-dark rounded">
                        ...
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">List TTD Surat</span>
                                </h3>
                            </div>
                        </div>
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#form_create">
                                    <i class="fas fa-plus"></i> Tambah TTD Surat
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body pt-0">
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="ttdSurat-table">
                            <thead class="">
...
@include('admin.ttd.create')
@include('admin.ttd.edit')
@include('admin.ttd.show')
@endsection
@section('js')
    ...
    @include('admin.ttd.script.index')
    @include('admin.ttd.script.create')
    @include('admin.ttd.script.edit')
    @include('admin.ttd.script.show')
@endsection
