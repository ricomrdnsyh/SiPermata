            ...
            <div id="kt_content_container" class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">List Surat Permohonan Observasi</span>
                                </h3>
                            </div>
                            <!--end::Search-->
                        </div>
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                <!--begin::Add user-->
                                <a href="{{ route('admin.surat-observasi.create') }}" class="btn btn-sm btn-primary"><i
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="surat-observasi-table">
                            <!--begin::Table head-->
                            <thead class="">
                                <!--begin::Table row-->
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            let table = $('#surat-observasi-table').DataTable({
                processing: false,
                serverSide: true,
                responsive: true,
                ...
                buttons: [{
                        extend: 'excelHtml5',
                        title: 'Data Pengajuan Surat Permohonan Observasi',
                ...
                ajax: {
                    url: '{{ route('admin.surat-observasi.data') }}',
                    data: function(d) {
