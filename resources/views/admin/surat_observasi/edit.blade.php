...
@section('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const simptUrl = "{{ route('admin.surat-observasi.simpt', '__NIM__') }}";
            ...
            if (pengajuSelect) {
                ...
                if (window.jQuery) {
                    jQuery(pengajuSelect)
                        .off('.simptObservasiAdmin')
                        .on('change.simptObservasiAdmin select2:select.simptObservasiAdmin', function() {
