...
@include('admin.akademik.create')
@include('admin.akademik.edit')
@include('admin.akademik.show')
@endsection
@section('js')
    ...
    @include('admin.akademik.script.index')
    @include('admin.akademik.script.create')
    @include('admin.akademik.script.edit')
    @include('admin.akademik.script.show')
@endsection
