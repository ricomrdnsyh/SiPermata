<div class="modal fade" id="form_create" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <form id="form_create_akademik" action="{{ route('admin.akademik.store') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="fv-row mb-3">
                        <label class="required fw-semibold fs-6 mb-2">Kode Akademik</label>
                        <input type="text" name="kode_akademik" class="form-control form-control-sm" required />
                    </div>
                    <div class="fv-row mb-3">
                        <label class="required fw-semibold fs-6 mb-2">Tahun Akademik</label>
                        <input type="text" name="tahun_akademik" class="form-control form-control-sm" required />
                    </div>
                </div>
