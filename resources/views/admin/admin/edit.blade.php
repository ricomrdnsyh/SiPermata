                            ...
                            <div class="card card-flush h-lg-100" id="kt_contacts_main">
                                ...
                                <div class="card-body pt-5">
                                    <form id="kt_ecommerce_settings_general_form"
                                        ...
                                        action="{{ route('admin.admin.update', $data->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="fv-row mb-7">
                                            <label class="required fw-semibold fs-6 mb-2">Nama Admin</label>
                                        ...
                                        <div class="fv-row mb-7">
                                            <label class="required fw-semibold fs-6 mb-2">Password(Kosongkan jika tidak
                                                mengganti)</label>
