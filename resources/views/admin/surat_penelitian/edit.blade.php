                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div id="form-container" class="mt-2">
                                <form id="kt_ecommerce_settings_general_form"
                                    ...
                                    action="{{ route('admin.surat-izin-penelitian.update', $surat->id_surat_izin_penelitian) }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="fv-row mb-3">
                                        ...
                                        <textarea name="judul_penelitian" class="form-control form-control-sm mb-3 mb-lg-0" rows="3">{{ old('judul_penelitian', $surat->judul_penelitian) }}</textarea>
