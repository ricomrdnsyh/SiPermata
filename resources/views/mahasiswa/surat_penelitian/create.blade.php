                                ...
                                <form id="kt_ecommerce_settings_general_form"
                                    ...
                                    <div class="fv-row mb-3">
                                        ...
                                        <select class="form-select form-select-sm select2-hidden-accessible w-100"
                                            ...
                                            <option value="" data-select2-id="select2-data-74-9zwr" required>
                                    ...
                                    <div class="fv-row mb-3">
                                        ...
                                        <input type="date" name="tgl_mulai" class="form-control form-control-sm mb-3 mb-lg-0" required/>
                                        @error('tgl_mulai')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="fv-row mb-3">
                                        ...
                                        <input type="date" name="tgl_selesai" class="form-control form-control-sm mb-3 mb-lg-0" required/>
                                        @error('tgl_selesai')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
