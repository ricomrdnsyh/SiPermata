                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div id="form-container" class="mt-2">
                                    <form id="kt_ecommerce_settings_general_form"
                                            ...
                                            <div class="row g-5">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $akademikLulusan ? $akademikLulusan->tahun_akademik : $latestAkademik?->tahun_akademik }}"
                                                        disabled />
                                        ...
                                        <div class="form-group-box">
                                            <h5 class="mb-5 text-gray-600"><i class="fas fa-user text-gray-400 me-2"></i>
                                                Data Pribadi Mahasiswa</h5>
                                            <div class="row g-5">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="position-relative">
                                                        ...
                                                        <input type="text" class="form-control ps-12"
                                                            value="{{ auth()->user()->mahasiswa?->tanggal_lahir ? \Carbon\Carbon::parse(auth()->user()->mahasiswa->tanggal_lahir)->format('d/m/Y') : '-' }}"
                                                            disabled />
                                        ...
                                        <div class="form-group-box">
                                            <h5 class="mb-5 text-gray-600"><i class="fas fa-book text-gray-400 me-2"></i>
                                                Data Tugas Akhir</h5>
                                            <div class="row g-5">
                                                <div class="col-md-12">
                                                    <label class="required fw-semibold fs-6 mb-2">Judul Penelitian/Tugas
                                                        Akhir</label>
                                                    <textarea class="form-control" rows="3" disabled>{{ old('judul_penelitian', $surat->judul_penelitian) }}</textarea>
                                                    <input type="hidden" name="judul_penelitian"
                                                        value="{{ old('judul_penelitian', $surat->judul_penelitian) }}">
                                        ...
                                        <div class="text-center mt-8">
                                            <button type="submit" data-kt-contacts-type="submit"
                                                ...
                                                <span class="indicator-label"><i class="fas fa-paper-plane me-2"></i> Ajukan
                                                    Ulang</span>
