                                            ...
                                            <div class="row g-5">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" name="nip" class="form-control"
                                                        placeholder="Contoh: 198010202005011003" value="{{ old('nip', $surat->nip) }}" required />
                                                    @error('nip')
                                                        <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="nama_ortu" class="form-control"
                                                        placeholder="Nama Lengkap Orang Tua" value="{{ old('nama_ortu', $surat->nama_ortu) }}" required />
                                                    @error('nama_ortu')
                                                        <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <select class="form-select" data-control="select2"
                                                        ...
                                                        <option value=""></option>
                                                        <option value="Tidak sekolah" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'Tidak sekolah' ? 'selected' : '' }}>Tidak sekolah</option>
                                                        <option value="PAUD" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'PAUD' ? 'selected' : '' }}>PAUD</option>
                                                        <option value="TK / sederajat" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'TK / sederajat' ? 'selected' : '' }}>TK / sederajat</option>
                                                        <option value="Putus SD" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'Putus SD' ? 'selected' : '' }}>Putus SD</option>
                                                        <option value="SD / sederajat" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'SD / sederajat' ? 'selected' : '' }}>SD / sederajat</option>
                                                        <option value="SMP / sederajat" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'SMP / sederajat' ? 'selected' : '' }}>SMP / sederajat</option>
                                                        <option value="SMA / sederajat" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'SMA / sederajat' ? 'selected' : '' }}>SMA / sederajat</option>
                                                        <option value="Paket A" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'Paket A' ? 'selected' : '' }}>Paket A</option>
                                                        <option value="Paket B" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'Paket B' ? 'selected' : '' }}>Paket B</option>
                                                        <option value="Paket C" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'Paket C' ? 'selected' : '' }}>Paket C</option>
                                                        <option value="D1" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'D1' ? 'selected' : '' }}>D1</option>
                                                        <option value="D2" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'D2' ? 'selected' : '' }}>D2</option>
                                                        <option value="D3" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'D3' ? 'selected' : '' }}>D3</option>
                                                        <option value="D4" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'D4' ? 'selected' : '' }}>D4</option>
                                                        <option value="S1" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'S1' ? 'selected' : '' }}>S1</option>
                                                        <option value="SP-1" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'SP-1' ? 'selected' : '' }}>SP-1</option>
                                                        <option value="S2" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'S2' ? 'selected' : '' }}>S2</option>
                                                        <option value="SP-2" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'SP-2' ? 'selected' : '' }}>SP-2</option>
                                                        <option value="S3" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'S3' ? 'selected' : '' }}>S3</option>
                                                        <option value="Non Formal" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'Non Formal' ? 'selected' : '' }}>Non Formal</option>
                                                        <option value="Informal" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'Informal' ? 'selected' : '' }}>Informal</option>
                                                        <option value="Pendidikan Profesi" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'Pendidikan Profesi' ? 'selected' : '' }}>Pendidikan Profesi</option>
                                                        <option value="Lainnya" {{ old('pendidikan_terakhir', $surat->pendidikan_terakhir) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                                                    </select>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="pangkat" class="form-control"
                                                        placeholder="Contoh: Pembina Tk. I" value="{{ old('pangkat', $surat->pangkat) }}" required />
                                                    @error('pangkat')
                                                        <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="golongan" class="form-control"
                                                        placeholder="Contoh: IV/b" value="{{ old('golongan', $surat->golongan) }}" required />
                                                    @error('golongan')
                                                        <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="position-relative">
                                                        ...
                                                        value="{{ old('tmt', $surat->tmt ? date('Y-m-d', strtotime($surat->tmt)) : '') }}" autocomplete="off" required />
</div>
                                                    @error('tmt')
                                                        <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                                    @enderror
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" name="unit_kerja" class="form-control"
                                                        placeholder="Unit kerja orang tua" value="{{ old('unit_kerja', $surat->unit_kerja) }}" required />
                                                    @error('unit_kerja')
                                                        <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="form-group-box">
                                            ...
                                            <div class="row g-5">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="required fw-semibold fs-6 mb-2">Pangkat</label>
                                                    <input type="text" name="pangkat" class="form-control"
                                                        placeholder="Contoh: Ahli Muda" value="{{ old('pangkat', $surat->pangkat) }}" required />
                                                    @error('pangkat')
                                                        <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                                    @enderror
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="required fw-semibold fs-6 mb-2">Golongan</label>
                                                    <input type="text" name="golongan" class="form-control"
                                                        placeholder="Contoh: IX" value="{{ old('golongan', $surat->golongan) }}" required />
                                                    @error('golongan')
                                                        <small class="text-danger mt-1 d-block">{{ $message }}</small>
                                                    @enderror
                                                </div>
