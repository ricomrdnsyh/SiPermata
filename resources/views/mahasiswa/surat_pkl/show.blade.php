                    ...
                    <div class="card-body p-lg-17">
                        <div class="d-flex flex-column">
                            <div class="mb-13 text-center">
                                <h1 class="fs-2hx fw-bolder mb-5">Detail Surat Permohonan Permohonan PKL</h1>
                            ...
                            <div id="form-container" class="mt-2">
                                <form id="kt_ecommerce_settings_general_form"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="mitra_is" class="form-control mb-3 mb-lg-0"
                                            value="{{ $surat->mitra ? $surat->mitra->nama_mitra : '-' }}" disabled />
                                    </div>
                                    <div class="fv-row mb-7">
                                        <label class="required fw-semibold fs-6 mb-2">Tanggal Mulai</label>
                                        <input type="text" name="tgl_mulai" class="form-control mb-3 mb-lg-0"
