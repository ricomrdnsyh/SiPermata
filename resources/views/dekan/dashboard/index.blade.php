        ...
        <div class="d-flex flex-column flex-column-fluid">
            <div id="kt_app_content" class="app-content flex-column-fluid mt-7">
                ...
                <div class="row g-4 g-xl-6 mb-7">
                    ...
                    <div class="col-xl-2 col-md-4">
                        <a href="{{ route('dekan.history.index', ['status' => 'pengajuan']) }}"
                    ...
                    <div class="col-xl-2 col-md-4">
                        <a href="{{ route('dekan.history.index', ['status' => 'proses']) }}"
                    ...
                    <div class="col-xl-2 col-md-4">
                        <a href="{{ route('dekan.history.index', ['status' => 'diterima']) }}"
                    ...
                    <div class="col-xl-2 col-md-4">
                        <a href="{{ route('dekan.history.index', ['status' => 'selesai']) }}"
                    ...
                    <div class="col-xl-2 col-md-4">
                        <a href="{{ route('dekan.history.index', ['status' => 'ditolak']) }}"
