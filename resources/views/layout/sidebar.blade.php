        ...
        <div class="hover-scroll-overlay-y px-2 my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                @if (Auth::user()->role == 'BAK')
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Request::is('bak/template') ? 'active' : '' }}"
                            href="{{ route('bak.template.index') }}">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                @if (Auth::user()->role == 'mahasiswa')
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Request::is('mahasiswa/surat-aktif/create') ? 'active' : '' }}"
                            href="{{ route('mahasiswa.suratAktif.create') }}">
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                <span class="svg-icon svg-icon-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
